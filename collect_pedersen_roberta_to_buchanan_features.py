...
token_file = '/home/gsc685/data/collected_tokens/senseval2/pedersen_tokens.csv'
...
def get_buchanan_feature_labels():
    ...
    feature_labels.sort()
    return feature_labels #FUUUUUUUUCJJJJJJJJKKKKK
...
for word in unique_lemmas:
    ...
    data = list(zip(df['sentence'], df['word_form']))
    #print(data)
    ...
    feature_labels = get_buchanan_feature_labels()
    ...
    for cluster_index, i in enumerate(good_indices): # you have lists of different indexing. clusters and embeddings and features are all squished together and indexed wrong
        ...
        for value in feature_vec:
            ...
            ids.append(row.id) # the sentence id
